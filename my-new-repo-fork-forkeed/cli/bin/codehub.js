...
program
    ...
    .action(async () => {
        ...
        try {
            ...
            console.error(chalk.red('❌ Signup failed:'), err.response?.data?.error || err.message);
        }
    });
...
program
    ...
    .action(async (repo_name, options) => {
        ...
        try {
            ...
            console.error(chalk.red('❌ Failed to create repo:'), err.response?.data?.error || err.message);
        }
    });
...
program
    ...
    .action(async (owner_repo) => {
        ...
        try {
            const res = await axios.get(`${API_BASE}/git/pull/${owner}/${repo}`);
            ...
            console.error(chalk.red('❌ Clone failed:'), err.response?.data?.error || err.message);
        }
    });
...
program
    ...
    .action(async (message) => {
        ...
        try {
            ...
            console.error(chalk.red('❌ Commit failed:'), err.response?.data?.error || err.message);
        }
    });
...
issuesCmd
    ...
    .action(async (owner_repo) => {
        ...
        try {
            ...
            console.error(chalk.red('❌ Failed to fetch issues:'), err.response?.data?.error || err.message);
        }
    });
